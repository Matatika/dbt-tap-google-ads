...
with campaign_performance_by_age_range_and_device_stream as (
    select * from "{{var('schema')}}".stream_campaign_performance_by_age_range_and_device
),
campaign_performance_by_age_range_and_device as (
    ...
    from campaign_performance_by_age_range_and_device_stream
)
